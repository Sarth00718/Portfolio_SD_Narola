    ...
    <section id="contact" className="section-container" ref={ref}>
      ...
      <div className="text-center mb-14">
        ...
        <motion.p
          ...
          className="text-slate-400 max-w-lg mx-auto mt-4 leading-relaxed"
          style={{
            fontSize: "clamp(0.875rem, 2vw, 1rem)",
            color: "var(--text-secondary)",
          }}
        >
          Looking for full-time SDE opportunities for 2027. Open to internships
          and interesting project collaborations too.
        </motion.p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 sm:gap-8 lg:gap-10 w-full">
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                Final-year student actively looking for{" "}
                <strong
                  style={{
                ...
                starting mid-2027. Also open to internships.
              </p>
            </div>
          </div>
              ...
              >
                {item.href ? (
                  <a
                    ...
                    style={{ background: cardBg, border: cardBorder }}
                    onMouseEnter={(e) => {
                      if (item.hoverStyle.borderColor)
                        e.currentTarget.style.borderColor =
                          item.hoverStyle.borderColor;
                      if (item.hoverStyle.color)
                  ...
                  >
                    <div className="w-10 h-10 rounded-xl flex items-center justify-center border border-white/10 flex-shrink-0">
                      <ContactIcon size={16} className="text-slate-400" />
                    </div>
                    <div>
                      <div
                        style={{
                  ...
                  >
                    <div className="w-10 h-10 rounded-xl flex items-center justify-center border border-white/10 flex-shrink-0">
                      <ContactIcon size={16} className="text-slate-500" />
                    </div>
                    <div>
                      <div
                        style={{
        ...
        >
          ...
          >
            ...
            >
              Powered by <span className="text-blue-400">EmailJS</span> — your
              message lands directly in my inbox.
            </p>
