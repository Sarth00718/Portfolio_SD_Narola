...
export const PROFILE = {
  ...
  address:
    "104, New Shakti Vijay Society, Varachha Road, Surat, Gujarat, India",
...
export const CP_PROFILES = [
  {
    ...
    status: "Active",
    description:
      "Solving problems across arrays, DP, graphs, and system design concepts",
  ...
  },
  {
    ...
    status: "Active",
    description:
      "Practicing competitive programming — greedy, graphs, number theory",
    link: "http://codeforces.com/profile/sarthnarola007",
    color: "#3b82f6",
  ...
  },
  {
    ...
    status: "2★ Rated",
    description:
      "Achieved 2-star rating through consistent long-contest participation",
